...
def register_scheduled_jobs(scheduler, app):
    ...
    # Lead generation automation (daily at 8 AM UTC)
    ...
    # Daily email blast to all unsent contacts (daily at 12 PM UTC / Noon)
    # Runs 4 hours after main automation (8am) to catch any remaining contacts
    scheduler.add_job(
